...
tracker_bus = Sort(max_age=20, min_hits=3,iou_threshold=0.3) # tracking de seguimiento para motos

limits = [200,347,673,347]
...
while True:
    ...
    results_tracker_bus = tracker_bus.update(detections_bus)
    ...
    cv2.putText(img,str(len(bus_count)),(655,100),cv2.FONT_HERSHEY_PLAIN,5,colours[1],8)
